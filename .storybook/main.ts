...
const config: StorybookConfig = {
  ...
  viteFinal: async (config) => {
    ...
    config.resolve.alias = {
      ...
      'expo-linear-gradient': resolve(__dirname, '../stories/stubs/expo-linear-gradient.ts'),
      'expo-router': resolve(__dirname, '../stories/stubs/expo-router.ts'),
      'expo-router/drawer': resolve(__dirname, '../stories/stubs/expo-router-drawer.ts'),
    };
