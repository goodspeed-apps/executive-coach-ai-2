...
export function Checkbox({ checked, onToggle, label, disabled = false, accessibilityLabel, testID }: CheckboxProps) {
  ...
  return (
    <TouchableOpacity
      ...
      disabled={disabled}
      accessibilityLabel={accessibilityLabel ?? label ?? 'Toggle checkbox'}
      testID={testID}
