...
export interface ChipProps {
  ...
  onPress?: () => void;
  onClose?: () => void;
  /** Test ID for automated testing (defaults to a slug of the label) */
  testID?: string;
}

export function Chip({ label, variant = 'filled', selected = false, onPress, onClose, testID }: ChipProps) {
