 ...
 * dark buttons.
 *
 * For multi-color brand marks (Google, Microsoft, LinkedIn) we map each segment
 * to the closest semantic palette key. For monochrome marks (Apple, X) we keep
 * the caller-supplied `color` prop.
 */
