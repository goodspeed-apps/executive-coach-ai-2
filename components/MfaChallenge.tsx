  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        <TextInput
          ref={inputRef}
          style={[styles.codeInput, { borderColor: error ? colors.error : colors.border, color: colors.text, backgroundColor: colors.surface }]}
          value={code}
        ...
        <TouchableOpacity
          style={[
            styles.verifyButton,
            { backgroundColor: canSubmit ? colors.primary : colors.disabled, opacity: verifying ? 0.7 : 1 },
          ]}
