  ...
  return (
    ...
    >
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          onPress={() => canSubmit && handleVerify(code)}
          disabled={!canSubmit}
        ...
        >
          {verifying ? (
            <ActivityIndicator accessibilityLabel="Loading" color={colors.textOnPrimary} />
          ) : (
            <Text style={[styles.buttonText, { color: colors.textOnPrimary }]}>Verify</Text>
          )}
        </TouchableOpacity>
