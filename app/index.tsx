...
export default function Splash() {
  ...
  // Delegate the redirect decision to the pure resolveColdLoadRedirect function.
  const firstTab = gasConfig.navigation.tabs[0]?.file ?? 'index';
  const href = resolveColdLoadRedirect({
    session: !!session,
    hasOnboarded: !!hasOnboarded,
    onboardingEnabled: gasConfig.features.onboarding.enabled,
    firstTab,
  });
