        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: colors.border }}>
            ...
            <TouchableOpacity onPress={markResolved}>
              <Text style={{ color: active?.status === 'resolved' ? colors.textSecondary : colors.success, fontSize: 14 }}>
              ...
              {messages.map((msg) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={{ color: isAdmin ? colors.primaryMuted : colors.textSecondary, fontSize: 11, marginTop: 4 }}>
          ...
          <View style={{ flexDirection: 'row', padding: 12, borderTopWidth: 1, borderTopColor: colors.border, gap: 8 }}>
            ...
            <TouchableOpacity
              ...
              style={[styles.sendButton, { opacity: sending || !reply.trim() ? 0.5 : 1 }]}
            >
              {sending ? (
