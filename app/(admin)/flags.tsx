...
const toggleEnabled = useCallback(async (flag: FlagRow) => {
  ...
  if (loading) {
    return <View style={[styles.center, { backgroundColor: colors.background }]}><ActivityIndicator accessibilityLabel="Loading" /></View>;
  }

  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Button label="Add flag" onPress={() => setShowForm(true)} style={styles.addBtn} testID="flags-add" accessibilityLabel="Add feature flag" />
<VirtualList
        data={flags}
...
<View style={styles.sliderRow}>
              ...
              <TextInput
                ...
                maxLength={3}
                accessibilityLabel={`Rollout percent for ${item.key}`}
      ...
      <Modal visible={showForm} animationType="slide" presentationStyle="formSheet" onRequestClose={() => setShowForm(false)}>
        <View style={[styles.form, { backgroundColor: colors.background }]}>
          ...
          <TextInput
            ...
            accessibilityLabel="Flag key (snake_case)"
            value={draft.key}
          ...
          <TextInput
            ...
            placeholderTextColor={colors.textSecondary}
            accessibilityLabel="Flag description (optional)"
...
<View style={styles.formRow}>
            ...
            <TextInput
              ...
              keyboardType="number-pad"
              maxLength={3}
              accessibilityLabel="Rollout percent"
          ...
          <View style={styles.formActions}>
            <Button label="Cancel" onPress={() => setShowForm(false)} variant="ghost" testID="flags-form-cancel" accessibilityLabel="Cancel new feature flag" />
            <Button label="Add" onPress={addFlag} loading={saving} testID="flags-form-submit" accessibilityLabel="Save new feature flag" />
          </View>
        </View>
      </Modal>
    </View>
