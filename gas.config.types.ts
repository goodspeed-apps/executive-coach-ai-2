...
export interface GasDesignVariants { auth?: string; settings?: string; nav?: string; }

export interface GasVisualParams {
...
export interface GasDesignIntent {
  descriptor: string;
  params: GasVisualParams;
}

export interface GasMotion {
...
export interface GasExpression {
  concept: string;
...
export interface GasDesignSystem {
  ...
  layout: GasLayout;
  designIntent?: GasDesignIntent | null;
  motion?: GasMotion | null;
  expression?: GasExpression | null;
  variants?: GasDesignVariants;
}
...
export interface GasNavigation {
  ...
  modals: Array<string>;
  navigationPattern: "tab-bar" | "drawer" | "hub-and-spoke";
  tabBarVariant?: "standard" | "floating" | "minimal" | "icon-only" | null;
}
...
export interface GasPerformanceConfig {
  ...
  /** Maximum gzip bytes for the whole-app JS export (kit size budget). */
  maxKitBytesGz?: number;
}
